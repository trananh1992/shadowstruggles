...
public class CharacterTest {
	...
	public void WalkUpTest() {
		...
		if (walkedUp)
			...
			System.out.println("WalkUpTest: SuccessFail!");
	}
	...
	public void WalkDownTest() {
		...
		if (walkedDown)
			...
			System.out.println("WalkDownTest: SuccessFail!");
	}
	...
	public void WalkLeftTest() {
		...
		if (walkedLeft)
			...
			System.out.println("WalkLeftTest: SuccessFail!");
	}
	...
	public void WalkRightTest() {
		...
		if (walkedRight)
			...
			System.out.println("WalkRightTest: SuccessFail!");
	}
