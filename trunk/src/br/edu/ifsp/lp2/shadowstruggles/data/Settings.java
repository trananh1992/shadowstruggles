...
/***
 * Class used as a container for the game's settings, so that they
...
public class Settings implements Serializable {
	...
	public int bottomElementY = 10; // Y-coordinate of an element at the bottom GUI.
	public int deckX = 830;
	public int energyX = 100; // X-coordinate of energy bar.
	public int firstCardX = 200; // X-coordinate of the first card on the player's hand.
	public int cardSpacing = 0;
	public int lifeBarY = 500; // Y-coordinate of both of the life bars.
	public int playerLifeX = 20;
	public int enemyLifeX = 0;
	...
	public void read(Json json, OrderedMap<String, Object> jsonData) {
		...
		playerMaxEnergy = json.readValue("playerMaxEnergy", Integer.class, jsonData);
		enemyMaxEnergy = json.readValue("enemyMaxEnergy", Integer.class, jsonData);
		playerInitialEnergy = json.readValue("playerInitialEnergy", Integer.class, jsonData);
		enemyInitialEnergy = json.readValue("enemyInitialEnergy", Integer.class, jsonData);
		...
		energyIncrease = json.readValue("energyIncrease", Integer.class, jsonData);
		language = json.readValue("language", String.class, jsonData);
		
		backgroundWidth = json.readValue("backgroundWidth", Integer.class, jsonData);
		backgroundHeight = json.readValue("backgroundHeight", Integer.class, jsonData);
		bottomElementY = json.readValue("bottomElementY", Integer.class, jsonData);
