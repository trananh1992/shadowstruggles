...
import br.edu.ifsp.lp2.shadowstruggles.data.EffectDAO;
import br.edu.ifsp.lp2.shadowstruggles.data.FighterDAO;
import br.edu.ifsp.lp2.shadowstruggles.data.TrapDAO;
...
public class Shop {
	...
	public Shop(ShadowStruggles game) {
		...
		//TODO: transferir cartas do lockedCards p/ availableCards de acordo com progresso do profile
	}
